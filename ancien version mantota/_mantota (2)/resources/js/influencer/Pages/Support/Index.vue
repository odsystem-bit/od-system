...
<template>
    ...
    <div class="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
            ...
            <Link :href="route('influencer.support.create')" class="inline-flex items-center gap-2 rounded-xl bg-teal-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-teal-700">
        ...
        <div v-if="!tickets.data.length" class="rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-sm">
            ...
            <Link :href="route('influencer.support.create')" class="mt-4 inline-flex items-center gap-2 rounded-xl bg-teal-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-teal-700">
        ...
        <div v-else class="space-y-3">
            <Link
                ...
                :key="ticket.id"
                :href="route('influencer.support.show', ticket.id)"
