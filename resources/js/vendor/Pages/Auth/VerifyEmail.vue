...
const submit = () => {
    form.post(route('vendor.verification.send'));
};
...
<template>
    ...
    <div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-purple-50 px-4 py-12">
        <div class="w-full max-w-md space-y-6 rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
            ...
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-purple-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-purple-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div v-if="verificationLinkSent" class="rounded-lg bg-purple-50 px-4 py-3 text-center text-sm font-medium text-purple-700">
            ...
            <form @submit.prevent="submit">
                <div class="flex items-center justify-between gap-4">
                    <button
                        ...
                        class="rounded-lg bg-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-purple-500 disabled:opacity-50"
                    >
                        Renvoyer le lien
                    </button>
