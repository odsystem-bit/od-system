...
class SupportController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $moderation = app(ChatModeratorService::class)->moderate($validated['message'], 'Support vendeur', $user->name);
        ...
        return redirect()->route('vendor.support.show', $ticket)
    ...
    public function reply(Request $request, SupportTicket $ticket): RedirectResponse
    {
        ...
        $moderation = app(ChatModeratorService::class)->moderate($request->message, 'Support vendeur', $request->user()->name);
